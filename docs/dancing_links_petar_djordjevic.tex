...
\abstract{
  ...
  Knut \cite{knuth2000dancing}, omogućava brzu i efikasnu manipulaciju matricama
...
\section{Uvod}
\label{sec:uvod}
Problem tačnih pokrivača ({\em Exact Cover Problem}) je klasičan kombinatorni problem odabira podskupova
